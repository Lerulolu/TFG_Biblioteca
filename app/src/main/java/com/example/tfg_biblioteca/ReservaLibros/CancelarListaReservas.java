...
public class CancelarListaReservas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cancelar_lista_reservas);
        ...
        layoutListaReservas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                dialogo.setTitle("Realizar Reserva").
                        ...
                        .setPositiveButton("Aceptar", (dialogInterface, j) -> {
                            cancelarReservaLibro(reservaElegida);
                        })
                        .setNegativeButton("Cancelar", (dialogInterface, j) -> {
    ...
    private void cancelarReservaLibro(ReservaLibro reserva){

        RequestQueue requestQueue = Volley.newRequestQueue(this);

        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://192.168.0.37:80/proyecto_tfg/cancelarReservaAlumno.php",

                response -> {
                    Toast.makeText(this, "Se ha cancelado la reserva del libro", Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() {
                Map<String, String> params = new HashMap<>();
                params.put("idReservaLibro", ""+reserva.getIdReservaLibro());
                return params;
            }
        };
